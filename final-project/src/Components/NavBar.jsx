          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            {auth ?
              <>
                ...
                <Button variant="dark-outline" className='Link keys'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cart" viewBox="0 0 16 16">
